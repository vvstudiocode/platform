            ...
            <CollapsibleSection title="基本資訊" defaultOpen={true}>
                <div className="space-y-4">
                    <div>
                        ...
                        <Input id="name" name="name" required defaultValue={store.name} className="bg-background" />
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                        <label className="flex items-center gap-3 p-3 rounded-lg border border-border bg-muted/20 cursor-pointer hover:border-primary/50 transition-colors">
                            <input
                                ...
                                defaultChecked={settings.payment_methods?.credit_card !== false} // Default true if undefined
                        ...
                        <label className="flex items-center gap-3 p-3 rounded-lg border border-border bg-muted/20 cursor-pointer hover:border-primary/50 transition-colors">
                            <input
                                ...
                                defaultChecked={settings.payment_methods?.bank_transfer !== false} // Default true
                                className="w-4 h-4 rounded border-input text-primary focus:ring-primary bg-background"
                            />
                            <div>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                            <div>
                                ...
                                <Input id="footer_line" name="footer_line" placeholder="https://..." defaultValue={(store.footer_settings as any)?.socialLinks?.line || ''} className="bg-background" />
                            </div>
                            <div>
                                <Label htmlFor="footer_facebook" className="text-xs text-muted-foreground">Facebook</Label>
                                <Input id="footer_facebook" name="footer_facebook" placeholder="https://..." defaultValue={(store.footer_settings as any)?.socialLinks?.facebook || ''} className="bg-background" />
                            </div>
                            <div>
                                <Label htmlFor="footer_instagram" className="text-xs text-muted-foreground">Instagram</Label>
                                <Input id="footer_instagram" name="footer_instagram" placeholder="https://..." defaultValue={(store.footer_settings as any)?.socialLinks?.instagram || ''} className="bg-background" />
                            </div>
                            <div>
                                <Label htmlFor="footer_threads" className="text-xs text-muted-foreground">Threads</Label>
                                <Input id="footer_threads" name="footer_threads" placeholder="https://..." defaultValue={(store.footer_settings as any)?.socialLinks?.threads || ''} className="bg-background" />
                            </div>
                            <div>
                                <Label htmlFor="footer_youtube" className="text-xs text-muted-foreground">YouTube</Label>
                                <Input id="footer_youtube" name="footer_youtube" placeholder="https://..." defaultValue={(store.footer_settings as any)?.socialLinks?.youtube || ''} className="bg-background" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <Input id="footer_email" name="footer_email" type="email" placeholder="contact@example.com" defaultValue={(store.footer_settings as any)?.email || ''} className="bg-background" />
                        </div>
                        <div>
                            <Label htmlFor="footer_phone">電話 (10碼)</Label>
                            <Input id="footer_phone" name="footer_phone" placeholder="例：0912345678" maxLength={10} defaultValue={(store.footer_settings as any)?.phone || ''} className="bg-background" />
                        </div>
                    </div>

                    <div>
                        <Label htmlFor="footer_address">地址</Label>
                        <Input id="footer_address" name="footer_address" placeholder="台北市..." defaultValue={(store.footer_settings as any)?.address || ''} className="bg-background" />
                    </div>
                    ...
                    <div>
                        ...
                        <Input id="footer_copyright" name="footer_copyright" placeholder="© 2024 商店名稱" defaultValue={(store.footer_settings as any)?.copyright || ''} className="bg-background" />
                    </div>
                </div>
            </CollapsibleSection>

            <Button type="submit" disabled={pending} className="w-full shadow-soft">
