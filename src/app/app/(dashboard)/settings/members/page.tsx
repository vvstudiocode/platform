...
export default async function AppMemberSettingsPage({ searchParams }: Props) {
    ...
    const defaultLevels = [
        ...
        { name: '黃金會員', min_spend: 10000, discount_type: 'percent', discount_value: 5, point_rate: 1.5 }, // 95折
        { name: '鑽石會員', min_spend: 50000, discount_type: 'percent', discount_value: 10, point_rate: 2 }, // 9折
    ]
