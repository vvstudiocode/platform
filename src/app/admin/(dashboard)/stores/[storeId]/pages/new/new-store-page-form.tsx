...
import { createStorePage } from '../actions'
...
export function NewStorePageForm({ storeId, storeName }: Props) {
    const createAction = createStorePage.bind(null, storeId)
    const [state, formAction, pending] = useActionState(createAction, { error: '' })
