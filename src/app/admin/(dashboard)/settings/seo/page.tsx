        ...
        <div className="max-w-4xl mx-auto py-8">
            ...
            {fullTenant.plan_id === 'starter' ? (
                <div className="bg-card border border-border rounded-xl p-8 text-center shadow-sm">
                    ...
                    <a href="/admin/settings/billing" className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2">
                        升級方案
                    </a>
                </div>
            ) : (
